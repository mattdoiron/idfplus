...
class Settings(dict):
    ...
    def read_settings(self):
        ...
        self['hide_empty_classes'] = int(settings.value("hide_empty_classes", 1) or 1)
        ...
        self['default_column_width'] = int(settings.value("default_column_width", 120) or 120)
        self['class_table_font'] = settings.value("class_table_font", "Arial,9")
        self['show_units_in_headers'] = int(settings.value("show_units_in_headers", 0) or 0)
        self['show_units_in_cells'] = int(settings.value("show_units_in_cells", 0) or 0)
        settings.endGroup()
        ...
        self['obey_idf_options'] = int(settings.value("obey_idf_options", 1) or 1)
        self['save_units'] = int(settings.value("save_units", 0) or 0)
        self['save_hidden_classes'] = int(settings.value("save_hidden_classes", 0) or 0)
        self['save_hide_groups'] = int(settings.value("save_hide_groups", 0) or 0)
