...
class UI_MainWindow(object):
    ...
    def create_ui(self):
        ...
        # classTable.horizontalHeader().setResizeMode(QtGui.QHeaderView.ResizeToContents)
        classTable.verticalHeader().setResizeMode(QtGui.QHeaderView.ResizeToContents)
        ...
        # classTable.horizontalHeader().sectionResized.connect(classTable.resizeRowToContents)
        # classTable.verticalHeader().sectionResized.connect(classTable.resizeColumnToContents)
